...
- **个人中心首页** (`/`) — 头像、信息词条、一言打字效果、社交链接
- **博客板块** (`/blog`) — 基于 Astro Content Collections 的 Markdown 博客
- **视觉系统** — 自定义暗色主题、Space Grotesk 标题、Geist Variable 正文
...
| `src/components/BlogNav.astro` | 博客页顶部导航栏 |
...
**视觉约定**：博客页沿用站点「维度裂隙」主题——暗色虚空背景、红色主色 `oklch(0.58 0.22 18)`、青色点缀 `oklch(0.72 0.12 180)`、CRT 扫描线纹理、Space Grotesk 标题。
